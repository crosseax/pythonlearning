...
# StringIO is for str, BytesIO is for binary code
from io import BytesIO

f = BytesIO()
print (
    f.write('中文字幕'.encode('utf-8')), # 12
    f.getvalue(), #b'\xe4\xb8\xad\xe6\x96\x87\xe5\xad\x97\xe5\xb9\x95'
)

f = BytesIO(b'\xe4\xb8\xad\xe6\x96\x87\xe5\xad\x97\xe5\xb9\x95')
print (
    f.read(), # b'\xe4\xb8\xad\xe6\x96\x87\xe5\xad\x97\xe5\xb9\x95'
    f.read().decode('utf-8') # 中文字幕
)
...
# stringIO 比如说，这时候，你需要对获取到的数据进行操作，
# 但是你并不想把数据写到本地硬盘上，
# 这时候你就可以用stringIO
